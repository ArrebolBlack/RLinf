...
DERIVED_SCHEMA_VERSION = "rlinf-dynamic-benchmark-state-v0.2"
...
class DynamicBenchmarkStateSchema:
    ...
    def to_dict(self) -> dict[str, Any]:
        payload = {
            "schema_version": (
                DERIVED_SCHEMA_VERSION if self.derived_fields else SCHEMA_VERSION
            ),
        ...
        if self.derived_fields:
            payload["derived_fields"] = [
                asdict(field) for field in self.derived_fields
            ]
        return payload
